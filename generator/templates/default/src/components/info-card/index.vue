<template>
  <<%= options['ui-framework'] === 'element-ui' ? 'el-c' : 'C' %>ard <% if (options['ui-framework'] === 'iview') { %>:shadow="shadow"<% } %> class="info-card-wrapper" :padding="0">
  ...
  </<%= options['ui-framework'] === 'element-ui' ? 'el-c' : 'C' %>ard>
</template>
